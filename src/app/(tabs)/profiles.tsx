  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        // Caixa de Conteúdos e Petfis para o Instagram // Primeio Perfil
        ...
        <View style={styles.boxLive}>
          ...
          <View style={styles.video}>
            ...
            <Text style={styles.subtitleVideo}>
              Hosted by <Text style={styles.subtitleVideoColors}>Go Hader</Text>
            </Text>
            <VideoPlayer
          ...
          <View style={styles.video}>
            ...
            <Text style={styles.subtitleVideo}>
              Hosted by <Text style={styles.subtitleVideoColors}>Hartnet</Text>
            </Text>
            <VideoPlayer
          ...
          <View style={styles.video}>
            <Text style={styles.titleVideo}>
              Honda NSX <Text style={styles.titleVideoColors}>4K FULL-HD</Text>{" "}
            </Text>
            <Text style={styles.subtitleVideo}>
              Hosted by <Text style={styles.subtitleVideoColors}>Tomoki´s</Text>
            </Text>
            <VideoPlayer
              url="https://www.youtube.com/watch?v=jXs3bURC-oY"
              height={250}
          ...
          <View style={styles.video}>
            ...
            <Text style={styles.subtitleVideo}>
              Hosted by <Text style={styles.subtitleVideoColors}>NeoQual</Text>
            </Text>
            <VideoPlayer
          ...
          <View style={styles.video}>
            <Text style={styles.titleVideo}>
              Subaru BRZ <Text style={styles.titleVideoColors}>4K FULL-HD</Text>
            </Text>
            <Text style={styles.subtitleVideo}>
              Hosted by{" "}
              <Text style={styles.subtitleVideoColors}>Hartnet Midia</Text>
