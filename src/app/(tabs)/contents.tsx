      ...
      <View style={styles.container}>
        ...
        <View style={styles.main}>
          <Text style={styles.title}>
            More <Text style={styles.title}>Content</Text>for Navigation
          </Text>
          <View>
            <View style={styles.boxImage}>
              <Image
                source={{
                  uri: "https://i.pinimg.com/736x/fa/9e/4b/fa9e4bbb1bd078a217d6b87a85290e9a.jpg",
                }}
                style={styles.image}
              />
              <Image
                source={{
                  uri: "https://i.pinimg.com/736x/ab/70/c9/ab70c9bb6505e177be408f25f314265d.jpg",
                }}
                style={styles.image}
              />
              <Image
                source={{
                  uri: "https://i.pinimg.com/736x/fc/cb/67/fccb676e60ab22cde7f2662bd3ed6ef4.jpg",
                }}
                style={styles.image}
              />
            </View>
