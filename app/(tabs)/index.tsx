...
import { ScrollView, FlatList, Image,TouchableOpacity,StyleSheet, Text, View, Animated  } from 'react-native';
...
export default function App() {
  ...
  return (
    ...
    <ScrollView >
      <LinearGradient colors={['#000000', '#ff2626']} start={{ x:0.4, y:0.6 }} end={{ x:2.5, y:2.6}}>
          <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
            <View style={styles.container}>
              <StatusBar style="light" />
              <View style={styles.imageView}>
                <Image source={{ uri:  'https://i.pinimg.com/736x/5e/1a/08/5e1a08d7d7fb6ac44cb401558b89cbc7.jpg' }} style={styles.image} />
              </View>
              <View style={styles.main}>
                <Text style={styles.title}>Drift King</Text>
                <Text style={styles.subtitle}>Profiles in the Instragram of the culture Automotive</Text>
                <Text style={styles.boldTitle}>Introduction</Text>
                ...
                <View style={styles.boxContent}>
                  <Text style={styles.paragraph}>Follow the links for explore the vast contents make for you and others adimires of this world. </Text>
                </View>
